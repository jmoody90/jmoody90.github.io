...
$(window).scroll(function(event) {
    ...
    progressBottom2 = (topEdge - (cc2.offsetTop + cc2.scrollHeight ))/ (topEdge - bottomEdge);
    ...
    // Head BG
    colorfulContent[0].style.background = "linear-gradient(340deg,rgb(" + (0 + (nProgBottom1*28)) + ", " + (246 + (nProgBottom1*9)) + ", " + (255 - (nProgBottom1*104)) + "), rgb(" + (0 + (nProgTop1*28)) + ", " + (246 + (nProgTop1*9)) + ", " + (255 - (nProgTop1*104)) + "))";
    
    // SVG
    stop1[0].style.stopColor = "rgb(" + (0 + (nProgTop2*28)) + ", " + (246 + (nProgTop2*9)) + ", " + (255 - (nProgTop2*104)) + ")"
    stop2[0].style.stopColor = "rgb(" + (0 + (nProgBottom2*28)) + ", " + (246 + (nProgBottom2*9)) + ", " + (255 - (nProgBottom2*104)) + ")"
    ...
    gradientContentUnit[1].style.background = "linear-gradient(340deg,rgb(" + (0 + (nProgBottom4*28)) + ", " + (246 + (nProgBottom4*9)) + ", " + (255 - (nProgBottom4*104)) + "), rgb(" + (0 + (nProgTop4*28)) + ", " + (246 + (nProgTop4*9)) + ", " + (255 - (nProgTop4*104)) + "))";
    ...
    // 2a
    if ($(window).width() >= 751) {
        gradientSubhead[2].style.background = "linear-gradient(340deg,rgb(" + (0 + (nProgBottom8*28)) + ", " + (246 + (nProgBottom8*9)) + ", " + (255 - (nProgBottom8*104)) + "), rgb(" + (0 + (nProgTop8*28)) + ", " + (246 + (nProgTop8*9)) + ", " + (255 - (nProgTop8*104)) + "))";
    }
    else {
        gradientSubhead[2].style.background = "rgb(45, 45, 45)";
    }
    // 2b
    gradientSubhead[3].style.background = "linear-gradient(340deg,rgb(" + (0 + (nProgBottom9*28)) + ", " + (246 + (nProgBottom9*9)) + ", " + (255 - (nProgBottom9*104)) + "), rgb(" + (0 + (nProgTop9*28)) + ", " + (246 + (nProgTop9*9)) + ", " + (255 - (nProgTop9*104)) + "))";
